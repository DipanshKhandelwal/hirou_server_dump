# Generated by Django 2.2.1 on 2020-03-04 17:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route', models.ForeignKey(on_delete=None, to='master.TaskRoute', verbose_name='route')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_point', models.ForeignKey(null=True, on_delete=None, related_name='task_collection', to='master.TaskCollectionPoint', verbose_name='collection_point')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, null=True, upload_to='', verbose_name='image')),
                ('route', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='master.BaseRoute', verbose_name='route')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('available', models.BooleanField()),
                ('collection_point', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collection', to='master.CollectionPoint', verbose_name='collection_point')),
                ('garbage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='master.Garbage', verbose_name='garbage')),
            ],
            options={
