from .views import VehicleViewSet, CollectionPointViewSet, GarbageViewSet, ReportTypeViewSet, CustomerViewSet, BaseRouteViewSet, TaskRouteViewSet, TaskCollectionPointViewSet, TaskCollectionViewSet
